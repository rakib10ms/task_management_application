...
<div class="br-mainpanel" style="position: relative;">
    ...
    <div class="row">
      ...
      <table class="table" id="table1">
        <div class="row m-4" >
          <div class="col-md-4">
        <form action="{{route('admin.allTask')}}" method="GET">
          <input type="get" name="search" class="form-control" >
          <button type="submit" class="btn btn-success mt-2" >Search Task </button>
        </form>
          </div>
        </div>
  <thead>
